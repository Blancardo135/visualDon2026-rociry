...
Nous allons nous inspirer de leurs processus d'extraction de données. Toutefois, nous ne pouvons pas garantir l'objectivité exacte puisque ces données ne proviennent pas de nous, donc nous resterons vigilant·e·s et attentif·ve·s aux biais potentiels.
